	...
	public static function welcome_notice() {
		...
		<p class="sw-welcome-text">
			<?php
				...
				echo wp_kses_post( sprintf( __( 'Thank you for installing <strong>Woo Product Bundles</strong>. Ready to get started? <a href="%s">Click here to create your first bundle</a>.', 'woocommerce-product-bundles' ), admin_url( 'post-new.php?post_type=product&wc_pb_first_bundle=1&tutorial=true&tutorial_type=product-bundles' ) ) );
			?>
		</p>
		<?php
